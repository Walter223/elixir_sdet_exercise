defmodule LoginTest do
  ...
  test "Failed login attempts go to new page" do
    ...
    Loopers.check_for_element(".//button[text()='Log In']", 5)
    ...
    Loopers.click_until(".//button[@name='login']", ".//a[@text()='Forgot Password?']", 4)
    assert page_title() == "Log into Facebook | Facebook"
    assert current_path() == "/login/"
    assert current_url() == "https://www.facebook.com/login/"
  end
end